...
<body class="hold-transition layout-top-nav">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark"> SISTEM PARKIR MEDIA GROUP </h1>
						</div><!-- /.col -->
						<!-- /.col -->
					</div>
					<!-- /.row -->
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-6">
							<div class="card card-primary card-outline">
								<div class="card-body form-group">
									<input type="text" class="form-control" name="plat_no" id="plat_no" placeholder="PLAT NOMOR" autofocus="">
								</div>
								<div class="card-body form-group">
						...
						<div class="col-lg-6">
							<div class="card card-primary card-outline">
								<div class="card-body">
									<p class="card-text">Plat Nomor : <span id="plat_no"></span></p>
									...
									<p class="card-text">Date & Time IN : <span id="TAKEN_DATE"></span></p>
								</div>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="card card-primary card-outline">
								<div class="card-body">
									<table id="historyTbl" class="table table-striped table-hovered" style="font-size: 11pt;">
										<thead>
											<th width="5"></th>
											<th width="70">Plat Nomor</th>
											<th width="70">NIP</th>
											<th>Name</th>
											<th>Directorate</th>
											<th>Division</th>
											<th>Department</th>
											<th width="170">Date & Time IN</th>
										</thead>
										<tbody></tbody>
									</table>
								</div>
		...
		<footer class="main-footer">
			<!-- Default to the left -->
			<strong>Copyright &copy; 2020 <a href="javascript:void(0)">MIS METRO TV</a>.</strong> All rights reserved.
		</footer>
	</div>
	<!-- ./wrapper -->
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('#nip_field').keyup(function(e){
				...
				{
					$.ajax({
						url : base_url + 'welcome/find_data',
						type : 'POST',
						dataType : 'JSON',
						data : data,
						success : function (data) {
							if (data.type == 'done') {
								Swal.fire({
									type	: 'success',
									title 	: 'Success',
									text	: 'Berhasil Masuk ke area parkir',
									...
									$('#TAKEN_DATE').text(moment(data.data[0].TAKEN_DATE).format('DD MMMM YYYY HH:mm:ss'));
									$('#nip_field').focus();
									histTable();
								});
							}else{
			...
			$('.btn-submit').on('click', function () {
				...
				if (data.emp_id == '') {
					...
					$.ajax({
						url : base_url + 'welcome/find_data2',
						type : 'POST',
						dataType : 'JSON',
						data : data,
						success : function (data) {
			...
			function histTable() {
				var t = $('#historyTbl').DataTable({
					...
					"order"			: [ 0 , 'DESC'], 
					"ajax"			: {
						"url"			: base_url + "welcome/view_history",
						"type"			: "POST",
					},
					"pageLength"	: 5,
					"columnDefs"	:[{
